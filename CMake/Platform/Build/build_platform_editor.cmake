...
# S$ - STAGE FOUR - EDITOR EXECUTABLE
if(COMPILATION_PLATFORM STREQUAL "WIN32")
    include("${PROJECT_SOURCE_DIR}/CMake/Platform/Build/Editor/WIN32/S4/build_win32_s4.cmake")
elseif(COMPILATION_PLATFORM STREQUAL "UNIX")
    include("${PROJECT_SOURCE_DIR}/CMake/Platform/Build/Editor/UNIX/S4/build_unix_s4.cmake")
elseif(COMPILATION_PLATFORM STREQUAL "OSX")
    include("${PROJECT_SOURCE_DIR}/CMake/Platform/Build/Editor/OSX/S4/build_osx_s4.cmake")
elseif(COMPILATION_PLATFORM STREQUAL "RPI4")
    include("${PROJECT_SOURCE_DIR}/CMake/Platform/Build/Editor/RPI4/S4/build_rpi4_s4.cmake")
else()
    message(FATAL_ERROR "${COMPILATION_PLATFORM} NOT SUPPORTED.")
endif()