...
namespace MPE
{
class MPE_API OpenGLESShader : public Shader
{
  public:
    OpenGLESShader(const std::string &filepath, bool useEditorResource = false);
    OpenGLESShader(const std::string &name, const std::string &vertexSource, const std::string &fragmentSource);
