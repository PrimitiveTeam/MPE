 ...
 * @details This flag is used to enable debug profiling for the MPE engine. This is used to profile more abstracted code.
 * @date 2024-05-05
 ...
 * @details This flag is used to enable core debug profiling for the MPE engine. This is used to profile the core of the engine which can slow down the engine by a lot.
 * @date 2024-05-05
 * @note This macro is only available in debug builds.
 */
