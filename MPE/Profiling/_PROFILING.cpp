...
namespace MPE
{
Profiler::Profiler() : CURRENT_SESSION(nullptr), PROFILE_COUNT(0) {}
...
InstrumentationTimer::InstrumentationTimer(const char *name) : NAME(name), STOPPED(false)
{
