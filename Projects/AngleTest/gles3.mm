...
int main()
{
    ...
    // Obtain the native window handle and ensure it's layer-backed
    ...
    for (int i = 0; i < numConfigsAvailable; ++i)
    {
        ...
        std::cout << "Config " << i << ": R=" << redSize << " G=" << greenSize << " B=" << blueSize << " A=" << alphaSize << " Depth=" << depthSize
                  << " Type=" << renderableType << std::endl;
    }
